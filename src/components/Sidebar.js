...
const Sidebar = () => {
  ...
  return (
    <div className="hidden md:block md:w-56 lg:w-64 p-3 md:p-4 border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 overflow-y-hidden">
      <ul className="space-y-1 text-sm md:text-base">
        <Link  to="/" className="font-semibold mb-1 text-gray-900 dark:text-gray-100  hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded px-2 py-1 cursor-pointer">Home</Link>
        <Link
          to="/shorts"
